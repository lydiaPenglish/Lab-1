...
The other unsolvable problem occurred in Line 783 in `Conditions.Rmd`. Not sure about the meaning of the error message: *`err` inherits from `warning/condition` not `error_bad_argument`*. So the chunck of Lines 783-788 was comment out to avoid error message.  
