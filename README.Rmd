...
p_weather <- ggplot(weather) +
  geom_map(aes(map_id = StateFull, fill = DIFF, text = paste("State: ", toupper(StateFull), "<br>Elevation: ", Elevation, "<br>Time Zone: ", DIFF)), size=1, color="white", map = states_map) +
...
ggplotly(p_weather, , tooltip = "text")  
```
